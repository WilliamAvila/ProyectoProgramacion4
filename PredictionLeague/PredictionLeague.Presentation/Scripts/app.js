...
angular.module('app', ['ngCookies','ui.router', 'app.filters', 'app.services', 'app.directives', 'app.controllers'])
    ...
    .config(['$stateProvider', '$locationProvider','$httpProvider', function ($stateProvider, $locationProvider,$httpProvider) {
        ...
        $stateProvider
            ...
            //This are the user views
            .state('UserLeagues', {
                url: '/MyLeagues',
                layout: 'basic',
                templateUrl: '/views/UserViews/MyLeagues',
                controller: 'ShowLeaguesCtrl'
            })
            .state('HomeUser', {
                url: '/HomeUser',
                layout: 'basic',
                templateUrl: '/views/UserViews/HomeUser',
                controller: 'UserLeaguesCtrl'
            })
            .state('SearchLeagues', {
                url: '/SearchLeagues',
                layout: 'basic',
                templateUrl: '/views/UserViews/SearchLeagues',
                controller: 'ShowLeaguesCtrl'
    })
            .state('MakeAGuess', {
                url: '/MakeAPrediction',
                layout: 'basic',
                templateUrl: '/views/UserViews/MakeAPrediction',
                controller: 'UserLeaguesCtrl'
            })
            //Page Not Found
            .state('otherwise', {
